...
s.linkInternalFilters="javascript:,levelbrand.com"
...
/* Set client timezone as hour difference from GMT for Time Parting functions */
s.gmt='-6';	



s.campaignID='om';			//campaign variable
/* Set URL  */
s.mask = {
    'delim'            :':',
    'channel'          :'eVar30',
    ...
    'campaign id'      :'eVar32',
	'media'            :'eVar33',
    'creative element' :'eVar34',

    'pattern'         :'channel:partner:campaign id:media:creative element'
};
...
/* Campaign Stacking */
    if(!s.campaign)
    	s.campaign=s.getQueryParam(s.campaignID,'','',s.mask);
    ...
    s.prop25=s.eVar25=s.getPreviousValue(s.pageName,'gpv_p5','');                 // get previous page name for internal search

s.eVar35=s.getQueryParam('intcamp');
s.eVar36=s.getQueryParam('ss');
s.eVar6=s.prop3=s.getQueryParam('q');
s.eVar2=s.getQueryParam('slide');
...
s.trackingServer="firstscribe.112.2o7.net"
