...
String user1=(String) session.getAttribute("sena");
...
<p>
<font size="4">
MR.<p>Welcome: <%=username%><p> Thanks you for buying vegetables..

</font>
</p>
<span>
you will Receive Notification and Message regarding your Purchase and other Details from MR.<p>Welcome: <%=user1%><p>
</span>
<font size="4">
<BLINK>
<marquee>
THANK YOU!!! FOR BEING PART OF E-MANDI 
<marquee>
</BLINK>
</FONT>
</pre>
